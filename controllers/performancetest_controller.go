...
//+kubebuilder:rbac:groups=specs.my.domain,resources=performancetests,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=specs.my.domain,resources=performancetests/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=specs.my.domain,resources=performancetests/finalizers,verbs=update
